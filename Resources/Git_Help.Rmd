...
1. Go to the following repository on GitHub: https://github.com/KateriSalk/Hydrologic_Data_Analysis
...
`git remote add upstream https://github.com/KateriSalk/Hydrologic_Data_Analysis`
