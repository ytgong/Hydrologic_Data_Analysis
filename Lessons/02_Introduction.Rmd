...
European carbon market transaction data + carbon emission data

how carbon market impacts carbon emission
...
cubed = ((EnoDischarge$Discharge^(1/3))*0.3)^3
EnoDischarge = cbind(EnoDischarge, cubed)
rmean = rollmean(EnoDischarge$Discharge,30)
EnoDischarge = cbind(EnoDischarge, rmean)
