...
> aggregation: putting daily data together into weekly, or monthly data; reducing dimension

> subsampling: e.g. you have daily data last year but only weekly data this year, use subsampling instead of aggregation for last year data, to avoid smoothing the data
...
* **Spline**: curved version of linear, not outperform linear in hydrologic data analysis
...
# Inspect results
Mendotatrend ## p value > 0.05 => not reject null hypothesis; z score: both magnitude and direction of trend
# s: total sum of differences between one point and its next point
...
> overall it doesn't seem that there exists an obvious seasonality trend, but October and November may have some significant differences from other months.
